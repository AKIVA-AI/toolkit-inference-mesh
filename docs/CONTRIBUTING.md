...
Welcome to **Toolkit Inference Mesh** (Toolkit-branded Parallax fork). We welcome and accept all kinds of contributions, no matter how small or large.

Upstream project: https://github.com/GradientHQ/parallax
...
If you have questions specifically about upstream Parallax, their Discord/community resources may be helpful.
...
**Note:** For the upstream project, contributors typically fork `GradientHQ/parallax`. For the Toolkit fork, fork the Toolkit repository that contains this folder.
